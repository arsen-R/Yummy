...
import com.example.recipeapp.resources.password_label
import com.example.recipeapp.resources.round_visibility_24
import com.example.recipeapp.resources.round_visibility_off_24
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            val image = if (passwordVisible.value) {
                painterResource( Res.drawable.round_visibility_24)
            }
            else {
                painterResource( Res.drawable.round_visibility_off_24)
            }
